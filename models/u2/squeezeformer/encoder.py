...
from models.u2.squeezeformer.subsampling import (
    DepthwiseConv2dSubsampling4,
    TimeReductionLayer1D,
    TimeReductionLayer2D,
    TimeReductionLayerStream,
)
from models.u2.squeezeformer.encoder_layer import SqueezeformerEncoderLayer
...
from models.u2.squeezeformer.attention import RelPositionMultiHeadedAttention
from models.u2.squeezeformer.positionwise_feed_forward import PositionwiseFeedForward
from models.u2.squeezeformer.convolution import ConvolutionModule
    ...
    def forward_chunk(
        ...
        for i, layer in enumerate(self.encoders):
            ...
            xs, _, new_att_cache, new_cnn_cache = layer(
                ...
                att_mask,
                pos_emb,
                att_cache=att_cache[i : i + 1][:, :, ::factor, :][:, :, : pos_emb.size(1) - xs.size(1), :]
                if elayers > 0
