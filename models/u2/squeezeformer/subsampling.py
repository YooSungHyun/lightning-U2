...
from models.u2.transformer.subsampling import BaseSubsampling
from typing import Tuple
from models.u2.squeezeformer.conv2d import Conv2dValid
...
class DepthwiseConv2dSubsampling4(BaseSubsampling):
    ...
    def __init__(
        ...
        self.dw_conv = nn.Conv2d(
            in_channels=odim, out_channels=odim, kernel_size=3, stride=2, groups=odim if dw_stride else 1
        )
        self.act2 = nn.ReLU()
